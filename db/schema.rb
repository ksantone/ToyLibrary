...
ActiveRecord::Schema.define(version: 2018_05_21_145253) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.string "last_name"
    t.text "about"
    t.string "account_img_file_name"
    t.string "account_img_content_type"
    t.integer "account_img_file_size"
    t.datetime "account_img_updated_at"
